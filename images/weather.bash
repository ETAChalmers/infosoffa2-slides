...
curl http://wd.cfab.chalmers.se/pages/station/liveData.php --silent --output /tmp/data_curl.html
file=$(echo "cat //html/body/div/div/table/tr/td/div" |  xmllint --html --shell /tmp/data_curl.html)
rm -f /tmp/data_curl.html
